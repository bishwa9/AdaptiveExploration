function [ output] = plan_clustering( alpha )
...
[classmap, valuemap, truevalue] = simulator(ndomclasses, nrareclasses, siz, miscvar, sensorvar, nchannels, nvisiblechans, probrare);
...
pointToSample =start_id;
hmap = Entropy_feature_space(valuemap, pointToSample, 0, 1)
